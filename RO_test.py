...
if __name__ == '__main__':
    ...
    mode_detector = os.path.join(parentdir, 'model/mode_detector')
    pf_isolator = os.path.join(parentdir, 'model/pf_isolator_res')
    f_f_identifier = os.path.join(parentdir, 'model/f_f_identifier_res')
    f_r_identifier = os.path.join(parentdir, 'model/f_r_identifier_res')
    f_m_identifier = os.path.join(parentdir, 'model/f_m_identifier_res')
